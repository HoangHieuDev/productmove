...
namespace ProductMove_APP.Pages.DLPPManager
{
    public class NhapKho_By_KhachModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (phanquyen != null && phanquyen == "Nhà phân phối")
            {
                ...
                if (data_seriInput.Count == 1 && data_seriInput[0].idWarehouse == null)
                {
                    ...
                    var seri_update_information = new Seri
                    {
                        ...
                        idProduct = data_seriInput[0].idProduct,
                        idWarehouse = idwarehouseWithUser,
                        productStatus = "Máy đang trong giai đoạn sửa chữa",
                    };
                    ...
                    var detailwarehouse_check = (from data in listDetailWarehouse
                                                 ...
                                                 data.productStatus == "Máy đang trong giai đoạn sửa chữa" &&
